...
class FiniteStateMachine(Node):
    ...
    def move_forward(self):
        ...
        # Salva odometria corrente come punto di partenza della ricerca in rettilineo 
        ...
        # Calcola la distanza percorsa da (self.search_start_x, self.search_start_y)
        d = None    # TODO
    ...
    def scan(self):
        ...
        if self.turning_right:
            ...
            # Se ha raggiunto l'ampiezza desiderata (self.right_target_yaw), smette di ruotare
            if None:    # TODO
                
                # TODO: invia messaggio di stop per fermare il robot
    ...
    def approach(self):
        ...
        if self.target_box_ratio is not None:
            ...
            # TODO: se self.target_box_ratio è sufficientemente grande:
            # a. pubblica il messaggio di stop per fermare il robot
            # b. aggiorna self.state
            # c. ritorna
    ...
    def interact(self):
        ...
        self.get_logger().info(f"...")  # TODO

        self.stopped = None     # TODO
    ...
    def avoid(self):
        ...
        if self.obstacle_detected:
            ...
            direction = None    # TODO: il robot deve ruotare nella direzione più libera
        ...
        if self.avoiding:
            # Calcola la distanza percorsa dall'inizio dell'evitamento
            dist = None     # TODO
        ...
        if self.aligning:
            ...
            # Calcola l'angolo di errore rispetto all'orientamento di partenza
            angle_err = None    # TODO
    ...
    def align_to_target(self):
        ...
        # Calcola l'errore rispetto al centro della bounding box
        error = None    # TODO
